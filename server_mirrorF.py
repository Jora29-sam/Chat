            ...
            if data.startswith("/"):
                ...
                if data.startswith("/kick"):
                    try:
                        ...
                        client_socket.sendall("⚠️ Uso incorrecto. Usa: /kick nombre_usuario".encode())
                        continue
                    ...
                    if kicked:
                        ...
                        client_socket.sendall(f"⚠️ Usuario {target_user} no encontrado.".encode())
                    continue

                client_socket.sendall("⚠️ Comando no reconocido.".encode())
                continue
